...
if(!mysql_num_rows(mysql_query("SHOW TABLES LIKE 'bballtickets_config'"))){
      mysql_query("CREATE TABLE `bballtickets_config` (`id` int(11) NOT NULL AUTO_INCREMENT, `hold` text NOT NULL, `template` text NOT NULL, `conventus_id` text NOT NULL, `conventus_grouptype` text NOT NULL, `conventus_groupid` text NOT NULL, `conventus_enabled` tinyint(1) NOT NULL, `encode` text NOT NULL,PRIMARY KEY (`id`)) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1");
}
