...
if(!mysql_num_rows(mysql_query("SHOW TABLES LIKE 'bballtickets_config'"))){
      mysql_query("CREATE TABLE `bballtickets_config` (`id` int(11) NOT NULL AUTO_INCREMENT, `hold` text NOT NULL,`template` text NOT NULL, `encode` text NOT NULL,`template` text NOT NULL,PRIMARY KEY (`id`)) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1");
...
if(!mysql_num_rows(mysql_query("SHOW COLUMNS FROM `bballtickets_courts`"))){
      ...
      mysql_query("CREATE TABLE `bballtickets_conventus` (`id` text NOT NULL, `ticketid` text NOT NULL,`name` text NOT NULL,`team` text NOT NULL,) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1");
}
