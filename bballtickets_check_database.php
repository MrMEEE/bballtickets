...
if(!mysql_num_rows(mysql_query("SHOW COLUMNS FROM `bballtickets_courts`"))){
      ...
      mysql_query("CREATE TABLE `bballtickets_convensus` (`id` text NOT NULL, `ticketid` text NOT NULL,`name` text NOT NULL,`team` text NOT NULL,) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1");
}
